 ...
 */
+ (NSMutableData *)passwordDataForService:(NSString *)serviceName account:(NSString *)account;
 ...
 */
+ (NSMutableData *)passwordDataForService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;
